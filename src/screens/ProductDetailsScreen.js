...
export default function ProductDetailsScreen({ route }) {
  ...
  const productPrice = typeof product.price === 'number' ? product.price : 4.20;
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          >
            <Ionicons name={isFavorite ? "heart" : "heart-outline"} size={32} color={isFavorite ? '#d43a31' : "#fff"} />
          </TouchableOpacity>
        </View>

        {/* Shadow Card for details */}
        <View style={styles.shadowCard}>
          ...
          <View style={styles.titleRow}>
            ...
            <View style={styles.inlineIcons}>
              <View style={styles.iconInfo}>
                <MaterialCommunityIcons name="coffee" size={22} color="#a9745b" />
                <Text style={styles.iconText}>Coffee</Text>
              </View>
              <View style={styles.iconInfo}>
                <MaterialCommunityIcons name="glass-mug-variant" size={22} color="#a9745b" />
          ...
          {/* Rating and medium roasted badge */}
...
const styles = StyleSheet.create({
  ...
  price: {
    fontSize: 24,
    color: '#a9745b', // accent color, NOT white
    fontFamily: 'OpenSans-Bold',
    marginLeft: 2,
  },
  addToCartBtn: {
  ...
  barSpacer: {
    height: 35, // Extra bottom margin below Add to Cart bar
    backgroundColor: '#18181A',
  },
});
